...
- For users with a 24GB VRAM card (e.g., RTX 3090/4090) running ~27B models:
  - `Q4_K_M` is the safest baseline.
  - `Q5_K_M` is the recommended "sweet spot" for maximum quality without triggering slow system-RAM offloading.
  - `Q6_K` is risky and may cause OOM or slow-down as context grows.
